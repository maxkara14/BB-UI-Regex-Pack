...
- **Scene State** (бывш. Clocks) - интерактивный инфоблок состояния сцены: дата, время, локация, погода, конфликты, присутствующие персонажи, ключевые детали, текущий сюжет и направление развития. Сворачиваемый блок с анимацией.
...
- Lore Orbs: эфирный текст и читаемая вуаль для светлых тем.
- Radio: радио Каири, радио Акико, Lo-Fi Podcast Лона.
- Scene State: классическое стекло, красно-золотой, пыльная роза, хроники Сильвера.
