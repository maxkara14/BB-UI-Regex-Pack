...
[After this block, continue with the normal RP response.]`
    ...
    { 
        ...
        name: "⌛ clocks",
        prompt: `[TIME INFO]\n\n#1 RULE: EVERY response MUST begin with exactly one <info>...</info> line. No exceptions, even for short replies.\n\nFORMAT (strict — 5 fields, separated by ' | ', wrapped in <info></info>):\n<info>DD.MM.YY | DDD | LOCATION | EMOJI TEMP°C | HH:MM</info>\n\nFIELDS:\n1. Date: DD.MM.YY. Use in-world calendar fitting the setting (modern, fantasy, future — same DD.MM.YY shape).\n2. Day: 3-letter English weekday — Mon, Tue, Wed, Thu, Fri, Sat, Sun.\n3. Location: ALL CAPS, short (1–4 words). Examples: TOKYO STATION, KITCHEN, DARK ALLEYWAY, NORTHERN KEEP.\n4. Weather: one emoji + space + temperature + °C. Examples: ☀️ 24°C, 🌧️ 12°C, ❄️ -8°C, 🌫️ 5°C.\n5. Time: HH:MM in 24-hour format. Examples: 07:45, 14:20, 23:05.\n\nEXAMPLES:\n<info>14.07.24 | Sun | TOKYO STATION | ☀️ 28°C | 09:15</info>\n<info>03.11.342 | Thu | NORTHERN KEEP | ❄️ -4°C | 18:40</info>\n<info>22.05.87 | Wed | ABANDONED METRO | 🌫️ 9°C | 02:11</info>\n\nTIME JUMPS:\nIf the scene changes time or location mid-response (after ※/SCENE※), insert a fresh <info> line at the start of the new scene. Example:\n…they left the room.\n※/EPISODE※\n\n<info>14.07.24 | Sun | DARK ALLEYWAY | 🌧️ 19°C | 23:50</info>\n※SCENE: The Dark Alleyway※\nThe rain was pouring…\n\nFINAL CHECK BEFORE SENDING:\n1. First non-empty line of your message is an <info> tag.\n2. Exactly 5 fields separated by ' | '.\n3. Closing </info> is present.`
    },
    { 
        id: "transitions", 
